...
1. 깃헙의 레포지토리를 클론합니다.
   ...
   ```
   $ git clone https://github.com/hyungtaik/RunWithMe.git
   ```
...
1. 데이터베이스를 설정합니다.
   ...
   - [RunWithMe_SQL.sql](https://github.com/hyungtaik/RunWithMe/blob/master/doc/ERD/RunWithMe_SQL.sql)을 참고해서 데이터베이스를 생성합니다. ([여기](https://github.com/hyungtaik/RunWithMe/blob/master/doc/ERD/RunWithMe_ERD.png)를 눌러 erd를 확인하세요.)
